...
| Enter Auto | `connected && !controllerBusy && safetyOk && !emergencyStop && doorClosed && servoOn && allRequiredAxesHomed && !axisBusy && !axisAlarm && cameraConnected && ioReady && !alarmActive && !sequenceRunning` | `!connected`, `controllerBusy`, `!safetyOk`, `emergencyStop`, `!doorClosed`, `!servoOn`, `!allRequiredAxesHomed`, `axisBusy`, `axisAlarm`, `!cameraConnected`, `!ioReady`, `alarmActive`, `sequenceRunning` | Does not require active Recipe; Run Inspection enforces Recipe separately. |
