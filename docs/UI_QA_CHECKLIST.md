...
- [x] Re-inspect metadata comparison and metadata history are visible; source-image replay and new inspection-result replay persistence remain follow-up work.
- [x] Re-inspect readiness rows keep source replay, Recipe policy, persistence, and real sequence validation boundaries visible.
