...
Priority: P1
Status: Simulator fault injection and WPF monitor baseline implemented; EquipmentView now surfaces active fault and forced I/O summaries. Real hardware validation remains follow-up work.
