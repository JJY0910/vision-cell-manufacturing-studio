...
Priority: P1
Status: MotionView snapshot refresh and command availability now flow through `IMotionPanelUseCase`; Teaching Go To snapshot/interlock orchestration now flows through `ITeachingPointUseCase`; Recipe, Inspection, and Teaching history cleanup remain open.
