...
Priority: P1
Status: Addressed by the HMI theme/empty-state polish slice and follow-up star-column layout guard; Reports export, persisted Settings, and actual Offline Debug re-inspection execution remain follow-up work.
