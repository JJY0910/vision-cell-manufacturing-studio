...
Priority: P1
Status: Addressed by the startup/layout QA slice plus Dashboard/Equipment shared `CommandBar` alignment and Equipment compact fault-button styling; broader physical HMI panel review remains follow-up work.
