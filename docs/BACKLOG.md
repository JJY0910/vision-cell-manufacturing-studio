...
Priority: P1
Status: Addressed by the startup/layout QA slice plus Dashboard and Equipment shared `CommandBar` alignment; broader physical HMI panel review remains follow-up work.
