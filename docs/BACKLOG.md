...
Priority: P1
Status: Simulator fault injection, WPF monitor baseline, active fault/forced I/O summaries, and simulator I/O transition persistence are implemented. Real hardware validation remains follow-up work.
