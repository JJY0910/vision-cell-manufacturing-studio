...
- Current implementation executes simulator-backed Servo On/Off, Home All, typed Jog +/- axis steps, typed Move Absolute X/Y/Z/Theta/profile/tolerance targets, and Stop through `IMotionCommandUseCase`.
