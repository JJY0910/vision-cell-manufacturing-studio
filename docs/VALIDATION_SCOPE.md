...
- Offline Debug Re-inspect currently runs a deterministic metadata comparison over the prepared historical result context. Source-image replay, current-vs-historical Recipe resolution, replay result persistence, and real camera/motion/vision sequence execution are not implemented or validated.
